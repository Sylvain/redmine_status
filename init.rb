...
Redmine::Plugin.register :redmine_status do
  ...
  menu :top_menu, :statuses, {:controller => 'statuses', :action => 'index', :id => nil}, :caption => :redmine_status_title
  menu :project_menu, :statuses, {:controller => 'statuses', :action => 'index'}, :caption => :redmine_status_title
end
